...
class saastopuu_toolsAlgorithm_points(QgsProcessingAlgorithm):
    ...
    def initAlgorithm(self, config):
        ...
        #inputs
        self.addParameter(QgsProcessingParameterFeatureSource(self.INPUT,'tree map',[QgsProcessing.TypeVectorPoint],defaultValue='treemap_testi'))
    ...
    def name(self):
        ...
        """
        return 'Säästöpuuehdotus pisteelle'
    ...
    def createInstance(self):
        return saastopuu_toolsAlgorithm_points()
